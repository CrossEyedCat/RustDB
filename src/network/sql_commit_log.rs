...
//!
//! The embedded / config-driven APIs decide whether this append should be followed by `fsync`.
...
pub fn append_commit_log_line(data_dir: &Path, fsync_on_commit: bool) -> Result<()> {
