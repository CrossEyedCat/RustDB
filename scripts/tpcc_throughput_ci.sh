...
docker run -d --name "$CONTAINER_NAME" \
  ...
  ${RUSTDB_TPCC_NEW_ORDER_OL_CNT:+-e "RUSTDB_TPCC_NEW_ORDER_OL_CNT=${RUSTDB_TPCC_NEW_ORDER_OL_CNT}"} \
  ${RUSTDB_TPCC_ORDER_LINE_SHARDS:+-e "RUSTDB_TPCC_ORDER_LINE_SHARDS=${RUSTDB_TPCC_ORDER_LINE_SHARDS}"} \
