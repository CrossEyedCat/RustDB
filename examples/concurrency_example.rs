...
use rustdb::core::{
    ConcurrencyManager, ConcurrencyConfig, LockGranularity,
    RowKey, Timestamp, TransactionId, ResourceType,
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("     Deadlock'ов обнаружено: {}", lock_stats.deadlocks_detected);
